 ...
 * common objects. Currently supports: Mark, Rectangle, Path, Edge, Text label,
 * Circle, Circular Arc, Spline, Splinegon
 *
...
public class IpeDraw {
	...
	public static String drawIpeEdge(int x1, int y1, int x2, int y2,
		...
		return drawIpePath(new int[] { x1, x2 }, new int[] { y1, y2 }, color, pen,
		    dash);
	}
	 ...
	 * @return
	 */
	public static String drawIpeEdge(int x1, int y1, int x2, int y2, String color) {
		return drawIpePath(new int[] { x1, x2 }, new int[] { y1, y2 }, color);
	}

	/**
	 * Draws an undashed edge between two points with pen width "normal" and color
	 * "black".
	 *
	 * @param x1
	 *          x-coordinate of point 1
	 ...
	 * @return
	 */
	public static String drawIpeCircularArc(int xCenter, int yCenter, int xStart,
	    int yStart, int xEnd, int yEnd, String color, String pen, String dash) {
		double radius = Math.sqrt(Math.pow(xStart - xCenter, 2)
		    + Math.pow(yStart - yCenter, 2));
		String sf = new DecimalFormat("####.000").format(radius);
		return "<path stroke=\"" + color + "\" pen=\"" + pen + "\" dash=\"" + dash
		    + "\">\n " + xStart + " " + yStart + " m\n " + sf + " 0 0 " + sf + " "
		    + xCenter + " " + yCenter + " " + xEnd + " " + yEnd + " a\n</path>\n";
	}
	 ...
	 */
	public static String drawIpeCircularArc(int xCenter, int yCenter, int xStart,
	    int yStart, int xEnd, int yEnd, String color, String pen) {
	 ...
	 */
	public static String drawIpeCircularArc(int xCenter, int yCenter, int xStart,
	    int yStart, int xEnd, int yEnd, String color) {
		return drawIpeCircularArc(xCenter, yCenter, xStart, yStart, xEnd, yEnd,
		    color, "normal", "normal");
	}
	...
	public static String drawIpeSemiCircle(int xStart, int yStart, int xEnd,
	    int yEnd, String color) {
	 ...
	 * @return
	 */
	public static String drawIpeSpline(int[] x, int[] y, String color, String pen) {
	...
	public static String getIpePreamble() {
		return "<?xml version=\"1.0\"?>\n"
		    ...
		    + "    <info created=\"D:20131106154934\""
		    + " modified=\"D:20131106160041\"/>\n"
